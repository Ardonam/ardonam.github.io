...
class IconInfo extends Component {
  ...
  render() {
    return (
      <svg className="App-nav-icon" style={this.props.style} xmlns="http://www.w3.org/2000/svg" width={this.props.width} height={this.props.height} fillRule="evenodd" clipRule="evenodd" viewBox="0 0 24 24">
