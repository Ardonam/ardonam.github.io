...
class IconMusic extends Component {
  ...
  render() {
    return (
      <svg className="Music-icon" xmlns="http://www.w3.org/2000/svg" width={this.props.width} height={this.props.height} fillRule="evenodd" clipRule="evenodd" viewBox="0 0 24 24">
